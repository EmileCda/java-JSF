 ...
 * 
 */
@WebServiceClient(name = "StudentWebService", targetNamespace = "http://webservice.dove.emile.fr/", wsdlLocation = "http://localhost:9991/ws/StudentWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTWEBSERVICE_QNAME = new QName("http://webservice.dove.emile.fr/", "StudentWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9991/ws/StudentWebService?wsdl");
    ...
    public StudentWebService getStudentWebServicePort() {
        return super.getPort(new QName("http://webservice.dove.emile.fr/", "StudentWebServicePort"), StudentWebService.class);
    }
    ...
    public StudentWebService getStudentWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.dove.emile.fr/", "StudentWebServicePort"), StudentWebService.class, features);
    }
