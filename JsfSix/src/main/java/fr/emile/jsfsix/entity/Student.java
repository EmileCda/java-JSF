...
public class Student extends Person  implements IConstant{
	...
	public Student(int id,String firstname, String lastname, Gender gender, Date birthdate, String email,
			ServiceLevel serviceLevel, String phone, Position currentPosition, boolean isAvailable)
			 {
	...
	public Student (ResultSet resultSet) throws SQLException {
		...
		this(resultSet.getInt("id"),
				...
				Utils.toJavaDate(resultSet.getDate("birthdate")),
				resultSet.getString("email"),
				ServiceLevel.fromString(resultSet.getString("service_level")),			
				resultSet.getString("phone"),
				Position.fromString(resultSet.getString("position")),
				resultSet.getBoolean("is_delete")		
				
				);
		
		String langString =resultSet.getString("lang_list");
		

		String tabLang[]=langString.split(";");
